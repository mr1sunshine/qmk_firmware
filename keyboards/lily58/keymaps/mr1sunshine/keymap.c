...
[_LOWER] = LAYOUT( \
  ...
  KC_TILD, _______, _______, _______, _______, SEARCH,                    _______, _______, _______, _______, _______, _______, \
...
[_RAISE] = LAYOUT( \
  ...
  _______, _______, _______, _______, KC_LBRC, KC_RBRC,                   _______, LTSCRN,  KC_UP,   RTSCRN,  _______, KC_DEL, \
  _______, _______, _______, _______, KC_LCBR, KC_RCBR,                   _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, \
  _______, _______, _______, _______, _______, _______, _______, _______, KC_PLUS, KC_EQL,  _______, _______, _______, KC_BSLS, \
                             _______, _______, _______, _______, _______, _______, _______, _______ \
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
